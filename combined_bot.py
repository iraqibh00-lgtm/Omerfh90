...
_WORD_WHITELIST = {
    'كس':  ['تكسي', 'التكسي', 'تاكسي', 'التاكسي', 'ماكسي', 'باكستاني', 'باكستان', 'بلكسن', 'بلك سن', 'بلكسنن', 'كسور', 'كسارات', 'كسرا'],
